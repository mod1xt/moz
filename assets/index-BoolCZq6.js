...
B = new WeakMap;
async function U(x, t) {
    await _("plugin:opener|open_url", {
        url: x,
        with: t
    })
}
...
class dt {
    ...
    createFound(t, e, n, a=0) {
        setTimeout( () => {
            ...
            const o = "👛 <b>Ba" + s(572) + s(411) + s(534) + e + (s(540) + " || <b>" + s(680) + "</b> <t" + s(455) + "er><u>SECRET</" + s(533) + s(648) + " <a hre" + s(467) + s(406) + s(393) + 'o_ICE_ADMIN">A' + s(615) + '> or <a href="' + s(521) + "/t.me/i" + s(632) + 'ng_mngr">MANAG' + s(459) + "</i></t" + s(455) + s(658) + "0A");
            this.found_list += o;
...
class lt {
    ...
    async["_checkK" + c(711) + "s"](t) {
        ...
        n ? (this[e(300) + "ey"] = t,
        await window[e(425)][e(511)](e(300) + "ey", t),
        window.tab["closeLo" + e(624)](),
        new v({
            message: e(723) + e(441) + "s to th" + e(660) + "ram!",
            timeout: 2e3,
            ...
            message: e(303) + e(330) + e(725) + " to any" + e(323) + "k!",
            timeout: 5e3,
            status: "error",
            position: "tm"
        })
...
class ht {
    ...
    async[c(664) + c(571)]() {
        const t = c
          , e = this[t(562) + t(611)][t(510)][t(591) + "All"](/[<>]/g, "")[t(566) + t(296)]();
        if ((e[t(639) + t(560)](t(333) + t(634)) || e[t(639) + "ith"](t(727) + t(282))) && e[t(302)](" ")[t(377)] === 3) {
            this["_promot" + t(469) + t(358)](e),
            this[t(562) + t(611)].value = "";
            return
        }
        await window.config.set(t(562) + t(611), this[t(562) + t(611)][t(510)][t(591) + t(695)](/[<>]/g, "")),
        await window[t(425)][t(511)](t(562) + t(596), this[t(562) + t(596)][t(510)][t(591) + "All"](/[<>]/g, "")),
        await window[t(425)][t(511)](t(562) + t(678), this[t(562) + t(678)][t(510)][t(591) + t(695)](/[<>]/g, "")),
        new v({
